...
int EffectCreate() {
    ...
    if (ret < 0) {
        printf("EffectLibCreateEffect() init failed");
        free(module);
        return ret;
    }

    module->context.mState = REVERB_STATE_INITIALIZED;
    printf("EffectLibCreateEffect %p ,size %d", module, sizeof(reverb_module_t));

    return 0;
}

int EffectRelease(void* handle) {
    reverb_module_t *pRvbModule = (reverb_module_t *)handle;
    printf("EffectLibReleaseEffect %p", handle);
    if (handle == NULL) {
        return -EINVAL;
    }
...
static int Reverb_Process(void* self, audio_buffer_t *inBuffer, audio_buffer_t *outBuffer) {
...
static int Reverb_Command(void* self, uint32_t cmdCode, uint32_t cmdSize,
    ...
    printf("Reverb_Command command %d cmdSize %d",cmdCode, cmdSize);
    ...
    case EFFECT_CMD_GET_PARAM:
        printf("Reverb_Command EFFECT_CMD_GET_PARAM pCmdData %p, *replySize %d, pReplyData: %p",pCmdData, *replySize, pReplyData);
        ...
        printf("Reverb_Command EFFECT_CMD_GET_PARAM param %d, replySize %d",*(int32_t *)rep->data, rep->vsize);
    ...
    case EFFECT_CMD_SET_PARAM:
        printf("Reverb_Command EFFECT_CMD_SET_PARAM cmdSize %d pCmdData %p, *replySize %d, pReplyData %p",
    ...
    case EFFECT_CMD_SET_DEVICE:
        ...
        printf("Reverb_Command EFFECT_CMD_SET_DEVICE: 0x%08x", *(uint32_t *)pCmdData);
        break;
    case EFFECT_CMD_SET_VOLUME: {
        ...
        printf("Reverb_Command EFFECT_CMD_SET_VOLUME: left %f, right %f ", left, right);
        break;
        }
    case EFFECT_CMD_SET_AUDIO_MODE:
        ...
        printf("Reverb_Command EFFECT_CMD_SET_AUDIO_MODE: %d", *(uint32_t *)pCmdData);
        break;
    default:
...
int Reverb_Init(reverb_module_t *pRvbModule, int aux, int preset) {
    ...
    printf("Reverb_Init module %p, aux: %d, preset: %d", pRvbModule,aux, preset);
    ...
    ret = Reverb_setConfig(pRvbModule, &pRvbModule->config, 1);
    if (ret < 0) {
        printf("Reverb_Init error %d on module %p", ret, pRvbModule);
    }
...
int Reverb_setConfig(reverb_module_t *pRvbModule, effect_config_t *pConfig,
    ...
    if (pConfig->inputCfg.samplingRate
        ...
        printf("Reverb_setConfig invalid config");
        return -EINVAL;
    }
    ...
    case 48000:
        ...
        break;
    default:
        printf("Reverb_setConfig invalid sampling rate %d", pReverb->m_nSamplingRate);
        return -EINVAL;
    }
...
int Reverb_getParameter(reverb_object_t *pReverb, int32_t param, uint32_t *pSize,
    ...
    if (pReverb->m_Preset) {
        ...
        printf("get REVERB_PARAM_PRESET, preset %d", *pValue16);
    } else {
        switch (param) {
        ...
        case REVERB_PARAM_ROOM_LEVEL:
            ...
            *pValue16 = Effects_Linear16ToMillibels(temp);
            ...
            printf("get REVERB_PARAM_ROOM_LEVEL %d, gain %d, m_nRoomLpfFwd %d, m_nRoomLpfFbk %d", *pValue16, temp, pReverb->m_nRoomLpfFwd, pReverb->m_nRoomLpfFbk);
        ...
        case REVERB_PARAM_ROOM_HF_LEVEL:
            ...
            printf("get REVERB_PARAM_ROOM_HF_LEVEL, a1^2 %d", temp);
            temp2 = MULT_EG1_EG1(pReverb->m_nRoomLpfFbk, pReverb->m_nCosWT_5KHz)
                    << 1;
            printf("get REVERB_PARAM_ROOM_HF_LEVEL, 2 Cos a1 %d", temp2);
            temp = 32767 + temp - temp2;
            printf("get REVERB_PARAM_ROOM_HF_LEVEL, a1^2 + 2 Cos a1 + 1 %d", temp);
            temp = Effects_Sqrt(temp) * 181;
            printf("get REVERB_PARAM_ROOM_HF_LEVEL, SQRT(a1^2 + 2 Cos a1 + 1) %d", temp);
            temp = ((32767 - pReverb->m_nRoomLpfFbk) << 15) / temp;

            printf("get REVERB_PARAM_ROOM_HF_LEVEL, gain %d, m_nRoomLpfFwd %d, m_nRoomLpfFbk %d", temp, pReverb->m_nRoomLpfFwd, pReverb->m_nRoomLpfFbk);
        ...
        case REVERB_PARAM_DECAY_TIME:
            ...
            *pValue32 = (temp * 1000) / pReverb->m_nSamplingRate;
            ...
            printf("get REVERB_PARAM_DECAY_TIME, samples %d, ms %d", temp, *pValue32);
        ...
        case REVERB_PARAM_DECAY_HF_RATIO:
            ...
            if (pReverb->m_nRvbLpfFbk == 0) {
                *pValue16 = 1000;
                printf("get REVERB_PARAM_DECAY_HF_RATIO, pReverb->m_nRvbLpfFbk == 0, ratio %d", *pValue16);
            } else {
                ...
                printf("get REVERB_PARAM_DECAY_HF_RATIO, gain 5KHz %d mB, gain DC %d mB", temp, temp2);
                ...
                *pValue16 = temp;
                printf("get REVERB_PARAM_DECAY_HF_RATIO, ratio %d", *pValue16);
            }
        ...
        case REVERB_PARAM_REFLECTIONS_LEVEL:
            *pValue16 = Effects_Linear16ToMillibels(pReverb->m_nEarlyGain);
            ...
            printf("get REVERB_PARAM_REFLECTIONS_LEVEL, %d", *pValue16);
        ...
        case REVERB_PARAM_REFLECTIONS_DELAY:
            ...
            *pValue32 = (pReverb->m_nEarlyDelay * 1000) / pReverb->m_nSamplingRate;
            ...
            printf("get REVERB_PARAM_REFLECTIONS_DELAY, samples %d, ms %d", pReverb->m_nEarlyDelay, *pValue32);
        ...
        case REVERB_PARAM_REVERB_LEVEL:
            ...
            *pValue16 = Effects_Linear16ToMillibels(pReverb->m_nLateGain << 2);
            ...
            printf("get REVERB_PARAM_REVERB_LEVEL %d", *pValue16);
        ...
        case REVERB_PARAM_REVERB_DELAY:
            ...
            *pValue32 = (pReverb->m_nLateDelay * 1000) / pReverb->m_nSamplingRate;
            ...
            printf("get REVERB_PARAM_REVERB_DELAY, samples %d, ms %d", pReverb->m_nLateDelay, *pValue32);
        ...
        case REVERB_PARAM_DIFFUSION:
            ...
            *pValue16 = temp;
            printf("get REVERB_PARAM_DIFFUSION, %d, AP0 gain %d", *pValue16, pReverb->m_sAp0.m_nApGain);
        ...
        case REVERB_PARAM_DENSITY:
            ...
            *pValue16 = temp;
            ...
            printf("get REVERB_PARAM_DENSITY, %d, AP0 delay smps %d", *pValue16, pReverb->m_sAp0.m_zApOut - pReverb->m_sAp0.m_zApIn);
            break;
    ...
    *pSize = size;
    ...
    printf("Reverb_getParameter, context %p, param %d, value %d",
...
int Reverb_setParameter(reverb_object_t *pReverb, int32_t param, uint32_t size,
    ...
    printf("Reverb_setParameter, context %p, param %d, value16 %d, value32 %d",
    ...
    if (pReverb->m_Preset) {
        ...
        printf("set REVERB_PARAM_PRESET, preset %d", value16);
        ...
        case REVERB_PARAM_ROOM_LEVEL:
            ...
            printf("REVERB_PARAM_ROOM_LEVEL, gain %d, new m_nRoomLpfFwd %d, m_nRoomLpfFbk %d", temp, pReverb->m_nRoomLpfFwd, pReverb->m_nRoomLpfFbk);
            if (param == REVERB_PARAM_ROOM_LEVEL)
                break;
        ...
        case REVERB_PARAM_ROOM_HF_LEVEL:
            ...
            if (value16 == 0) {
                ...
                // dG^2
                temp = Effects_MillibelsToLinear16(value16);
                printf("REVERB_PARAM_ROOM_HF_LEVEL, HF gain %d", temp);
                temp = (1 << 30) / temp;
                printf("REVERB_PARAM_ROOM_HF_LEVEL, 1/ HF gain %d", temp);
                dG2 = (int32_t) (((int64_t) temp * (int64_t) temp) >> 15);
                printf("REVERB_PARAM_ROOM_HF_LEVEL, 1/ HF gain ^ 2 %d", dG2);
                // b = 2*(C-dG^2)/(1-dG^2)
                ...
                printf_IF(delta > (1<<30), " delta overflow %d", delta);

                printf("REVERB_PARAM_ROOM_HF_LEVEL, dG2 %d, b %d, delta %d, m_nCosWT_5KHz %d", dG2, b, delta, pReverb->m_nCosWT_5KHz);
                // m_nRoomLpfFbk = -a1 = - (- b + sqrt(delta)) / 2
                pReverb->m_nRoomLpfFbk = (b - Effects_Sqrt(delta) * 181) >> 1;
            }
            printf("REVERB_PARAM_ROOM_HF_LEVEL, olg DC gain %d new m_nRoomLpfFbk %d, old m_nRoomLpfFwd %d",
                    temp2, pReverb->m_nRoomLpfFbk, pReverb->m_nRoomLpfFwd);

            pReverb->m_nRoomLpfFwd
                    = MULT_EG1_EG1(temp2, (32767 - pReverb->m_nRoomLpfFbk));
            printf("REVERB_PARAM_ROOM_HF_LEVEL, new m_nRoomLpfFwd %d", pReverb->m_nRoomLpfFwd);
        ...
        case REVERB_PARAM_DECAY_TIME:
            ...
            printf("REVERB_PARAM_DECAY_TIME, delay smps %d, DT smps %d, gain mB %d",averageDelay, value32, temp);
            ...
            printf("REVERB_PARAM_DECAY_TIME, gain %d, new m_nRvbLpfFwd %d, old m_nRvbLpfFbk %d, reverb gain %d", temp, pReverb->m_nRvbLpfFwd, pReverb->m_nRvbLpfFbk, Effects_Linear16ToMillibels(pReverb->m_nLateGain));
        ...
        case REVERB_PARAM_DECAY_HF_RATIO:
            ...
            if (value16 == 1000) {
                ...
                printf("REVERB_PARAM_DECAY_HF_RATIO, DC gain %d, DC gain mB %d, 1000/R %d", temp2, temp, value32);

                temp = (int32_t) (((int64_t) temp * (int64_t) value32) >> 15);

                if (temp < -4000) {
                    printf("REVERB_PARAM_DECAY_HF_RATIO HF gain overflow %d mB", temp);
                    temp = -4000;
                }

                temp = Effects_MillibelsToLinear16(temp);
                printf("REVERB_PARAM_DECAY_HF_RATIO, HF gain %d", temp);
                // dG^2
                temp = (temp2 << 15) / temp;
                dG2 = (int32_t) (((int64_t) temp * (int64_t) temp) >> 15);
                ...
                printf("REVERB_PARAM_DECAY_HF_RATIO, dG2 %d, b %d, delta %d", dG2, b, delta);

            }

            printf("REVERB_PARAM_DECAY_HF_RATIO, gain %d, m_nRvbLpfFbk %d, m_nRvbLpfFwd %d", temp2, pReverb->m_nRvbLpfFbk, pReverb->m_nRvbLpfFwd);
        ...
        case REVERB_PARAM_REFLECTIONS_LEVEL:
            ...
            printf("REVERB_PARAM_REFLECTIONS_LEVEL, m_nEarlyGain %d", pReverb->m_nEarlyGain);
        ...
        case REVERB_PARAM_REFLECTIONS_DELAY:
            ...
            printf("REVERB_PARAM_REFLECTIONS_DELAY, m_nEarlyDelay smps %d max smp delay %d", pReverb->m_nEarlyDelay, maxSamples);
        ...
        case REVERB_PARAM_REVERB_LEVEL:
            ...
            printf("REVERB_PARAM_REVERB_LEVEL, m_nLateGain %d", pReverb->m_nLateGain);
        ...
        case REVERB_PARAM_REVERB_DELAY:
            ...
            printf("REVERB_PARAM_REVERB_DELAY, m_nLateDelay smps %d max smp delay %d", pReverb->m_nLateDelay, maxSamples);
        ...
        case REVERB_PARAM_DIFFUSION:
            ...
            printf("REVERB_PARAM_DIFFUSION, m_sAp0.m_nApGain %d m_sAp1.m_nApGain %d", pReverb->m_sAp0.m_nApGain, pReverb->m_sAp1.m_nApGain);
        ...
        case REVERB_PARAM_DENSITY:
            ...
            printf("REVERB_PARAM_DENSITY, Ap0 delay smps %d", temp);
...
int main(int argc, const char* argv[]) {
    ...
    if (reply != 0) {
        printf("Command enable call returned error %d\n", reply);
        return EXIT_FAILURE;
    }
    ...
    while (fread(in.data(), ioFrameSize, frameLength, finp.get()) == (size_t)frameLength) {
        ...
        (void)fwrite(out.data(), ioFrameSize, frameLength, fout.get());
