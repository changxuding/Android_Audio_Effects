...
AudioEqualizer * AudioEqualizer::CreateInstance(void * pMem, int nBands,
                                                ...
                                                int nPresets) {
    printf("AudioEqualizer::CreateInstance(pMem=%p, nBands=%d, nChannels=%d, "
...
void AudioEqualizer::configure(int nChannels, int sampleRate) {
    printf("AudioEqualizer::configure(nChannels=%d, sampleRate=%d)", nChannels,
         sampleRate);
...
void AudioEqualizer::setGain(int band, int32_t millibel) {
    printf("AudioEqualizer::setGain(band=%d, millibel=%d)", band, millibel);
...
void AudioEqualizer::setFrequency(int band, uint32_t millihertz) {
    printf("AudioEqualizer::setFrequency(band=%d, millihertz=%d)", band,
         millihertz);
    assert(band >= 0 && band < mNumPeaking + 2);
    if (band == 0) {
...
void AudioEqualizer::setBandwidth(int band, uint32_t cents) {
    printf("AudioEqualizer::setBandwidth(band=%d, cents=%d)", band, cents);
    assert(band >= 0 && band < mNumPeaking + 2);
...
void AudioEqualizer::setPreset(int preset) {
    printf("AudioEqualizer::setPreset(preset=%d)", preset);
...
void AudioEqualizer::commit(bool immediate) {
    printf("AudioEqualizer::commit(immediate=%d)", immediate);
...
void AudioEqualizer::process(const audio_sample_t * pIn,
                             audio_sample_t * pOut,
                             int frameCount) {
//    printf("AudioEqualizer::process(frameCount=%d)", frameCount);
...
void AudioEqualizer::enable(bool immediate) {
    printf("AudioEqualizer::enable(immediate=%d)", immediate);
...
void AudioEqualizer::disable(bool immediate) {
    printf("AudioEqualizer::disable(immediate=%d)", immediate);
